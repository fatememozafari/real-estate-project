            ...
            <!--end::Navbar-->
                ...
                <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                    ...
                    <div class="card-body p-9">
                        <form method="post" action="{{route('real-estate.locations.update', [$realEstate, $location])}}" enctype="multipart/form-data"
                        ...
                        <!--begin::Main column-->
                            <div class="d-flex flex-column gap-7 gap-lg-10 flex-row-fluid me-lg-10 ">
                                    ...
                                    <div class="card-body pt-0">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-10 fv-row">
                                                    <!--begin::Label-->
                                                @include('real-estate.__components.label',['title'=>'عنوان آگهی'])
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-10 fv-row">
                                                    <!--begin::Label-->
                                                @include('real-estate.__components.label',['title'=>'نوع ملک'])
                                                <!--end::Label-->
                                                    <!--begin::Input-->
                                                @include('real-estate.__components.select-2',[
                                                  'name'=>'type',
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-10 fv-row land-wrapper">
                                                    <!--begin::Label-->
                                                @include('real-estate.__components.label',['title'=>'متراژ بنا','required'=>'required'])
                                                <!--end::Label-->
                                                    <!--begin::Input-->
                                                @include('real-estate.__components.input-text',[
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="mb-10 fv-row">
                                                    <!--begin::Label-->
                                                @include('real-estate.__components.label',['title'=>' طول و عرض جغرافیایی'])
                                                <!--end::Label-->
                                ...
                                <div class="d-flex justify-content-end">
                                    <!--begin::Button-->
                                    <a href="{{route('real-estate.locations.all',[$realEstate,$location])}}" type="reset" class="btn btn-light me-5">انصراف
                                    </a>
                                    <!--end::Button-->
                                    <!--begin::Button-->
