            ...
            <!--end::Navbar-->
                ...
                <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                    ...
                    <div class="card-body p-9">
                        <form method="post" action="{{route('real-estate.real-estates.update',$realEstate)}}" enctype="multipart/form-data" id="kt_ecommerce_add_category_form"
                                ...
                                <div class="card card-flush py-4">
                                    ...
                                    <div class="card-body pt-0">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="mb-10 fv-row">
                                                    <!--begin::Label-->
                                                @include('real-estate.__components.label',['title'=>'نام مشاور املاک', 'class'=> 'required','required'=>1])
                                                <!--end::Label-->
                                                    <!--begin::Input-->
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-10 fv-row">
                                                    <!--begin::Label-->
                                                @include('real-estate.__components.label',['title'=>'مدیر', 'class'=> 'required','required'=>1])
                                                <!--end::Label-->
                                                    <!--begin::Input-->
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-10 fv-row">
                                                    <!--begin::Label-->
                                                @include('real-estate.__components.label',['title'=>'شماره مجوز', 'class'=> 'required','required'=>1])
                                                <!--end::Label-->
                                                    <!--begin::Input-->
                                                @include('real-estate.__components.input-text',[
                                                        'name'=> 'license_number',
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="mb-10 fv-row">
                                                    <!--begin::Label-->
                                                @include('real-estate.__components.label',['title'=>'آدرس'])
                                                <!--end::Label-->
                                                    <!--begin::Input-->
                                    ...
                                    <div class="card-footer">
                                        <div class="d-flex justify-content-end">
                                            <!--begin::Button-->
                                            <a href="{{route('real-estate.real-estates.all',$realEstate)}}" type="reset" class="btn btn-secondary me-5">انصراف</a>
                                            <!--end::Button-->
                                            <!--begin::Button-->
