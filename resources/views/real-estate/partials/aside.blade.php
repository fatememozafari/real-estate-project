...
<div id="kt_aside" class="aside pt-7 pb-4 pb-lg-7 pt-lg-17" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_toggle">
    ...
    <div class="aside-user mb-5 mb-lg-10" id="kt_aside_user">
        ...
        <div class="d-flex align-items-center flex-column">
            ...
            <div class="text-center">
                <!--begin::Username-->
                <a href=" " class="text-gray-800 text-hover-primary fs-4 fw-bolder">مشاوره املاک
                {{$realEstate['name']}}
                </a>
                <!--end::Username-->
                <!--begin::Description-->
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention menu-active-bg fw-semibold" id="#kt_aside_menu" data-kt-menu="true">
                ...
                <div class="menu-item menu-accordion">
                    ...
                    <span class="menu-link here show">
										...
										<span class="menu-title"> <a href="{{route('real-estate.dashboard',$realEstate)}}">داشبورد</a></span>
 									</span>
                    <!--end:Menu link-->
                </div>
                <!--end:Menu item-->
                ...
                <div class="menu-item menu-accordion">
                    ...
                    <span class="menu-link here show">
										...
										<span class="menu-title"> <a href="{{route('real-estate.staffs.all',$realEstate)}}">مدیریت کارمندان</a></span>
 									</span>
                <!--end:Menu link-->
            </div>
            <!--end:Menu item-->
                ...
                <div class="menu-item menu-accordion">
                    ...
                    <span class="menu-link here show">
										...
										<span class="menu-title"> <a href="{{route('real-estate.locations.all',$realEstate)}}">مدیریت آگهی ها</a></span>
 									</span>
                    <!--end:Menu link-->
                </div>
                <!--end:Menu item-->
                ...
                <div class="menu-item menu-accordion">
                    ...
                    <span class="menu-link here show">
										...
										<span class="menu-title"> <a href="{{route('real-estate.requests.all',$realEstate)}}">مدیریت درخواست ها</a></span>
 									</span>
                    <!--end:Menu link-->
                </div>
                <!--end:Menu item-->
                ...
                <div class="menu-item menu-accordion">
                    ...
                    <span class="menu-link here show">
										...
										<span class="menu-title"> <a href="{{route('real-estate.real-estates.show',$realEstate)}}">پنل مشاور املاک</a></span>
 									</span>
                    <!--end:Menu link-->
                </div>
                <!--end:Menu item-->
    ...
    <div class="aside-footer flex-column-auto px-6 px-lg-9" id="kt_aside_footer">
        ...
        <div class="d-flex flex-stack ms-7">
            <!--begin::Link-->
            <a href=" {{route('real-estate.logout',$realEstate)}}" class="btn btn-sm btn-icon btn-active-color-primary btn-icon-gray-600 btn-text-gray-600">
            ...
            <div class="ms-1">
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                    ...
                    <div class="menu-item px-3">
                        <div class="menu-content d-flex align-items-center px-3">
                            ...
                            <div class="d-flex flex-column">
                                <div class="fw-bold d-flex align-items-center fs-5">{{$realEstate->name}}
                                    <span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">{!! $realEstate->webPresent()->status !!}</span></div>
                    ...
                    <div class="menu-item px-5">
                        <a href="{{route('real-estate.real-estates.show',$realEstate)}} " class="menu-link px-5">ناحیه کاربری</a>
                    </div>
                    <!--end::Menu item-->
                    ...
                    <!--begin::Menu item-->
                    <div class="menu-item px-5">
                        <a href="{{route('real-estate.logout',$realEstate)}}" class="menu-link px-5">خروج</a>
                    </div>
                    <!--end::Menu item-->
                </div>
