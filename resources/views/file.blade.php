        ...
        <div id="kt_aside" class="aside pt-7 pb-4 pb-lg-7 pt-lg-17" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_toggle">
            ...
            <div class="aside-logo flex-column-auto px-9 mb-9 mb-lg-17 mx-auto" id="kt_aside_logo">
                ...
                <a href="../../demo15/dist/index.html">
                    <img alt="Logo" src="admin-assets/assets/media/logos/default.svg" class="h-30px logo theme-light-show" />
                    <img alt="Logo" src="admin-assets/assets/media/logos/default-dark.svg" class="h-30px logo theme-dark-show" />
                </a>
                <!--end::Logo-->
            </div>
            <!--end::Brand-->
                                        ...
                                        <div class="card-body p-5">
                                            ...
                                            <div class="d-flex flex-column text-start d-none" data-kt-filemanger-table="copy_link_result">
                                                ...
                                                <div class="text-muted fw-normal mt-2 fs-8 px-3">Read only.
                                                    <a href="../../demo15/dist/apps/file-manager/settings/.html" class="ms-2">Change permissions</a></div>
                                            </div>
                                            <!--end::Link-->
                                        </div>
                                    </div>
                                                ...
                                                <div class="form-check form-check-custom form-check-solid">
                                                    ...
                                                    <label class="form-check-label" for="kt_modal_move_to_folder_3">
                                                        <div class="fw-bold">
                                                            ...
                                                            <!--end::Svg Icon-->admin-assets/assets</div>
                                                    </label>
                                                    <!--end::Label-->
                                                </div>
                                                <!--end::Checkbox-->
...
<script src="{{asset('admin-assets/assets/js/custom/apps/file-manager/list.js')}}"></script>
