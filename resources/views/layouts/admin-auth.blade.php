        ...
        <div class="d-flex flex-lg-row-fluid w-lg-50 bgi-size-cover bgi-position-center order-1 order-lg-2" style="background-image: url(assets/media/misc/auth-bg.png)">
            ...
            <div class="d-flex flex-column flex-center py-7 py-lg-15 px-5 px-md-15 w-100">
                ...
                <a href="#" class="mb-0 mb-lg-12">
                    <img alt="Logo" src="{{asset('admin-assets/assets/media/logos/custom-1.png')}}" class="h-60px h-lg-75px" />
                </a>
                <!--end::Logo-->
                <!--begin::Image-->
                <img class="d-none d-lg-block mx-auto w-275px w-md-50 w-xl-500px mb-10 mb-lg-20" src="{{asset('admin-assets/assets/media/misc/auth-screens.png')}}" alt="" />
                <!--end::Image-->
                <!--begin::Title-->
...
<script src="{{asset('admin-assets/assets/js/custom/authentication/sign-in/general.js')}}"></script>
