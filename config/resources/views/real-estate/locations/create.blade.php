            ...
            <!--end::Navbar-->
                ...
                <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                    ...
                    <div class="card-body p-9">
                        <form method="post" action="{{route('real-estate.locations.store',$realEstate)}}"
                        ...
                        <!--begin::Main column-->
                            <div class="d-flex flex-column gap-7 gap-lg-10 flex-row-fluid me-lg-10 ">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-10 fv-row">
                                                    <!--begin::Label-->
                                                @include('real-estate.__components.label',['title'=>'عنوان آگهی','required'=>'required'])
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-10 fv-row">
                                                    <!--begin::Label-->
                                                @include('real-estate.__components.label',['title'=>'نوع تقاضا','required'=>'required'])
                                                <!--end::Label-->
                                                    <!--begin::Input-->
                                ...
                                <div class="d-flex justify-content-end">
                                    <!--begin::Button-->
                                    <a href="{{route('real-estate.real-estates.all',$realEstate)}}" type="reset"
