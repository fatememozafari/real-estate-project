    ...
    <div class="d-flex flex-column flex-row-fluid">
        ...
        <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
            ...
            <div class="container-fluid" id="kt_content_container">
                <!--begin::Navbar-->
            @include('real-estate.users.top-card')
            <!--end::Navbar-->
                <!--begin::details View-->
                <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                    <!--begin::Card body-->
                    <div class="card-body p-9">
                        <form method="post" action="{{route('real-estate.users.update',[$realEstate,$user])}}" enctype="multipart/form-data" id="kt_ecommerce_add_category_form"
                        ...
                        <!--begin::Main column-->
                            <div class="d-flex flex-column gap-7 gap-lg-10 flex-row-fluid me-lg-10 ">
                                ...
                                <div class="d-flex justify-content-end">
                                    <!--begin::Button-->
                                    <a href="{{route('real-estate.staffs.all',[$realEstate,$user])}}" type="reset" class="btn btn-secondary me-5">انصراف</a>
                                    <!--end::Button-->
                                    <!--begin::Button-->
