            ...
            <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                ...
                <div class="card-header cursor-pointer">
                    ...
                    <div class="card-title m-0">
                        <h3 class="fw-bold m-0">اطلاعات آگهی</h3>
                    </div>
                    <!--end::Card title-->
                    <!--begin::Action-->
                    <a href="{{route('admin.locations.edit',[$realEstate,$location])}}"
                        ...
                        <div class="card-body p-9">
                            ...
                            <div class="row mb-7">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <span
                                        class="fw-semibold text-gray-800 fs-6">{!! $location->webPresent()->contract !!}</span>
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="row mb-7">
                                ...
                                <div class="col-lg-8 d-flex align-items-center">
                                    <span
                                        class="fw-bold fs-6 text-gray-800 me-2">{!! $location->webPresent()->type !!}</span>
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="row mb-7">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <span
                                        class="fw-semibold text-gray-800 fs-6">{!! $location->webPresent()->direction !!}</span>
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="row mb-7">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <span
                                        class="fw-semibold text-gray-800 fs-6">{!! $location->webPresent()->cabinetMaterial !!}</span>
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="row mb-7">
                                ...
                                <div class="col-lg-8 d-flex align-items-center">
                                    <span
                                        class="fw-bold fs-6 text-gray-800 me-2">{!! $location->webPresent()->floorMaterial !!}</span>
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
