...
<div id="kt_aside" class="aside pt-7 pb-4 pb-lg-7 pt-lg-17" data-kt-drawer="true" data-kt-drawer-name="aside"
    ...
    <div class="aside-logo flex-column-auto px-9 mb-9 mb-lg-17 mx-auto" id="kt_aside_logo">
        <!--begin::Logo-->
        <a href="">
            <img alt="Logo" src="{{ asset('admin-assets/assets/media/logos/default.svg') }}"
                 class="h-30px logo theme-light-show"/>
            <img alt="Logo" src="{{ asset('admin-assets/assets/media/logos/default-dark.svg') }}"
    ...
    <div class="aside-user mb-5 mb-lg-10" id="kt_aside_user">
        ...
        <div class="d-flex align-items-center flex-column">
            ...
            <div class="symbol symbol-75px mb-4">
                <img
                    src="{{\auth('admin')->user()->webPresent()->avatar ?? asset('admin-assets/assets/media/avatars/300-1.jpg')}}"
                    alt=""/>
            </div>
            <!--end::Symbol-->
            <!--begin::Info-->
            <div class="text-center">
                ...
                <!--begin::Description-->
                <span
                    class="text-gray-600 fw-semibold d-block fs-7 mb-1">{{\auth('admin')->user()->first_name}} {{\auth('admin')->user()->last_name}}</span>
                <!--end::Description-->
            </div>
            <!--end::Info-->
        </div>
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention menu-active-bg fw-semibold" id="#kt_aside_menu"
                ...
                <div class="menu-item menu-accordion">
                    ...
                    <span class="menu-link here show">
										...
										<span class="menu-title"><a
                                                href="{{route('admin.dashboard')}}">داشبورد</a></span>
 									</span>
                    <!--end:Menu link-->
                </div>
                <!--end:Menu item-->
                ...
                <div class="menu-item menu-accordion">
                    ...
                    <span class="menu-link here show">
										...
										<span class="menu-title"><a
                                                href="{{route('admin.admins.all')}}">مدیریت ادمین ها</a></span>
 									</span>
                    <!--end:Menu link-->
                </div>
                <!--end:Menu item-->
                ...
                <div class="menu-item menu-accordion">
                    ...
                    <span class="menu-link here show">
										...
										<span class="menu-title"><a
                                                href="{{route('admin.users.all')}}">مدیریت کاربران</a></span>
 									</span>
                    <!--end:Menu link-->
                </div>
                <!--end:Menu item-->
                ...
                <div class="menu-item menu-accordion">
                    ...
                    <span class="menu-link here show">
										...
										<span class="menu-title"><a href="{{route('admin.locations.list')}}">مدیریت آگهی ها</a></span>
 									</span>
                    <!--end:Menu link-->
                </div>
                <!--end:Menu item-->
                ...
                <div class="menu-item menu-accordion">
                    ...
                    <span class="menu-link here show">
										...
										<span class="menu-title"><a href="{{route('admin.real-estates.all')}}">مدیریت مشاورین املاک</a></span>
 									</span>
                    <!--end:Menu link-->
                </div>
                <!--end:Menu item-->
            ...
            <div class="ms-1">
                ...
                <div
                    ...
                    <div class="menu-item px-3">
                        <div class="menu-content d-flex align-items-center px-3">
                            ...
                            <div class="d-flex flex-column">
                                <div class="fw-bold d-flex align-items-center fs-5">{{\auth('admin')->user()->first_name}} {{\auth('admin')->user()->last_name}}
                                    <span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">{!! auth('admin')->user()->webPresent()->status !!}</span>
                                </div>
                    ...
                    <div class="menu-item px-5">
                        <a href="{{route('admin.admins.show',\auth('admin')->id())}} " class="menu-link px-5">ناحیه کاربری</a>
                    </div>
                    <!--end::Menu item-->
